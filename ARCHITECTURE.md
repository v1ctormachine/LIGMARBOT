...
| `90-ui.js`             | In-page panel: ON/OFF, **`TEST (BotVersion.version)`**, **Cancel smoke on TEST** checkbox + **`ligmarbot.testUi.v1`**, **4-line** hint → `runUiTestBundle()`. Phase block, stats; **Planner** + `ligmarbot.plannerUi.v1`. |
