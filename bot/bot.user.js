  ...
  function plannerPickSkillOpeningPick(userOpts) {
    ...
    if (forcedReq) {
      ...
      if (forcedPick && forcedPick.matched) {
        ...
        return { slot: forcedPick.matched.idx, record: forcedPick.matched.record, chargeReleasePlan: forcedChargePlan };
      }
    ...
    if (useHorizon && horizonMs > 0 && paper && Number.isFinite(paper.dps) && paper.dps > 0) {
      ...
      if (executeChoice && executePair) {
        ...
        return { slot: executePair.idx, record: executePair.record, chargeReleasePlan: executeChargePlan };
      }
      if (bestPassingIdx !== null && bestPassingPair) {
        ...
        return { slot: bestPassingPair.idx, record: bestPassingPair.record, chargeReleasePlan: pickedChargePlan };
      }
      ...
      if (bestIdx !== null && bestDmg > threshold) {
        ...
        return { slot: pickedPair.idx, record: pickedPair.record, chargeReleasePlan: pickedChargePlan };
      }
    ...
    return { slot: first.idx, record: first.record, chargeReleasePlan: firstChargePlan };
  }
