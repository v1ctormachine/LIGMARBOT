...
This file was split from ARCHITECTURE.md (historical / speculative module layout). The canonical architecture description is the main ARCHITECTURE.md above the split point.
